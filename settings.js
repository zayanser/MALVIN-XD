...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~JiVmybhA#WxmFhSsJ7Yl6wEoqI94XiUdFBfizt4to4EZx3t4YFOU",
...
// make true if want auto voice reply if someone menetion you 
     ...
     MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/xg70ir.jpg",
// add custom menu and mention reply image url

       ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/xg70ir.jpg",
...
OWNER_NAME: process.env.OWNER_NAME || "𝗭𝗔𝗬𝗔𝗡𝗦𝗘𝗥",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*©𝗭𝗔𝗬𝗔𝗡𝗦𝗘𝗥*",
// add bot owner name    
